...
public abstract class VInventory extends ZUtils implements Cloneable {
	...
	protected InventoryResult preOpenInventory(ShopPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(ShopPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, ShopPlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, ShopPlugin plugin, Player player) {
	}
